...
export default function KnowledgePage() {
  ...
  const handleSearch = async () => {
    ...
    setLoading(true);
    try { const data = await searchKnowledge(query); setResults(data.results || []); }
